...
export default function EditTradeModal({ isOpen, onClose, onSaveChanges, trade }: EditTradeModalProps) {
  const [formData, setFormData] = useState({
    token: trade.token,
    usdc: trade.usdc.toString(),
    price: trade.price.toString(),
    marketCap: trade.marketCap,
    date: trade.date,
    contractAddress: trade.contractAddress,
    dexscreenerLink: trade.dexscreenerLink,
  });
