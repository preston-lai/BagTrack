export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center py-20 px-4 text-center">
      <h1 className="text-5xl font-bold mb-4">Effortless Swing Trade Tracking for Crypto</h1>
      ...
      <a href="#" className="inline-block px-8 py-4 bg-white text-black rounded-lg font-semibold shadow hover:bg-gray-100 transition text-lg">
        Start Tracking Now
      </a>
    </section>
  )
